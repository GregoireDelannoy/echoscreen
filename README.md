...
## Installation
 1. Install the system requirements: ```apt install gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-vaapi```
 ...
 * Automatic server discovery (there seems to be such a feature in the window client?)
 * Password support
 * Audio
 * ~~Pass a Qt widget directly to gstreamer, avoid unecessary frame unpacking + remove numpy dependency~~

    => [https://github.com/GregoireDelannoy/echoscreen/commit/d3b051a1bde0b16dcc4b471447bcf777bc530819](Done!) Much simpler code overall, less CPU usage, uses GTK instead of Qt which makes it even simpler on Gnome Ubuntu
